<?php
    ...
    $page_name = "bsulisting.php";
    $folder = "bsupictures";
    $university = "Bindura State University";
...
<head>
    ...
    ?> 
    <meta name="description" content="View Boarding Houses available for BIndura University of Science students to rent">
    <link rel="icon" href="../images/logowhite.png">
    <link rel="stylesheet" href="../index.css"> 
        <title>CasaMax BSU-ListingPage</title>
