...
?>    
    ...
    <form action= "../homerunphp/fpassscript.php" method="post">
                <div>
                    <h3 class="h3reg">Forgot Password!</h3>
                    <h1></h1>
                </div>
